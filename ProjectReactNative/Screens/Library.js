...
const LibraryScreen = () => {
  ...
  return (
    <ScrollView style={styles.container} accessible={true} accessibilityRole="main" accessibilityLabel="Music Player">
      ...
      <TouchableOpacity onPress={handleSearchScreen}>
        <Image
          resizeMode="contain"
          source={{
            uri: "https://cdn.builder.io/api/v1/image/assets/TEMP/6bbb62da11ba403beaad756b7a618209002bd403a70fd409d02f9eb2377a04e3?placeholderIfAbsent=true&apiKey=246443a9ddb849499eacf4ea5891bc1a",
          }}
    ...
    <View style={styles.tabContainer} accessibilityRole="tablist">
      {['Playlist', 'New tag', 'Songs', 'Albums', 'Artists'].map(tab => (
        <TouchableOpacity
          key={tab.toLowerCase()}
          style={[styles.tab, activeTab === tab.toLowerCase() && styles.activeTab]}
          onPress={() => {
            setActiveTab(tab.toLowerCase());
            // Điều hướng đến màn hình Playlist nếu tab là "Playlist"
            if (tab === 'Playlist') {
